...
(function () {
  ...
  const CSS_NAV_DATA = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: '📝 Section Quiz', url: '/csslessons/selectors/quiz.html', badge: 'quiz' },
      ]
    },
    {
      title: '📐 CSS Layout',
      items: [
        ...
        { title: '📝 Section Quiz', url: '/csslessons/layout/quiz.html', badge: 'quiz' },
      ]
    },
    {
      ...
      items: [
        ...
        { title: '📝 Section Quiz', url: '/csslessons/responsive/quiz.html', badge: 'quiz' },
      ]
    },
    {
      title: '✨ CSS Effects',
      items: [
        ...
        { title: '📝 Section Quiz', url: '/csslessons/effects/quiz.html', badge: 'quiz' },
      ]
    },
    {
      title: '🔧 Advanced CSS',
      items: [
        ...
        { title: '📝 Section Quiz', url: '/csslessons/advanced/quiz.html', badge: 'quiz' },
      ]
    },
    {
      title: '🎯 Interview Prep',
      items: [
        ...
        { title: '📝 Section Quiz', url: '/csslessons/interview/quiz.html', badge: 'quiz' },
      ]
    },
    {
      title: '🛠️ Projects',
      items: [
        ...
        { title: '📝 Section Quiz', url: '/csslessons/projects/quiz.html', badge: 'quiz' },
      ]
    },
  ];
  ...
  function initTryYourself() {
    const path = window.location.pathname;
    if (path.endsWith('/ide.html')) return;
    let lang = null;
    if (path.includes('/python/')) lang = 'python';
    else if (path.includes('/javascript/')) lang = 'javascript';
    else if (path.includes('/html/')) lang = 'html';
    else if (path.includes('/csslessons/')) lang = 'css';
    else if (path.includes('/sql/')) lang = 'sql';
    else if (path.includes('/git/')) lang = 'git';
    else if (path.includes('/odoo/')) lang = 'python';
    else if (path.includes('/owljs/')) lang = 'javascript';
    if (!lang) return;
    ...
    link.href = '/ide.html?lang=' + lang;
    link.target = '_blank';
    link.rel = 'noopener';
    const langLabel = { javascript: 'JavaScript', html: 'HTML', css: 'CSS', sql: 'SQL', git: 'Git', python: 'Python' }[lang] || 'Python';
    link.setAttribute('aria-label', 'Open the online ' + langLabel + ' IDE in a new tab');
